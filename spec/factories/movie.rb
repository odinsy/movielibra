FactoryGirl.define do
  factory :movie, class: MovieLibra::Movie do
  ...
  factory :classic_movie, class: MovieLibra::Movie::ClassicMovie do
  ...
  factory :ancient_movie, class: MovieLibra::Movie::AncientMovie do
    list { build(:my_movie_list) }
  ...
  factory :modern_movie, class: MovieLibra::Movie::ModernMovie do
    list { build(:my_movie_list) }
  ...
  factory :new_movie, class: MovieLibra::Movie::NewMovie do
    list { build(:my_movie_list) }
